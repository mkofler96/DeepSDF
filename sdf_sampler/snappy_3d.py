...
class Snappy3D(_TileBase):
    ...
    def create_tile(
        ...
        **kwargs,  # noqa ARG002
        ...
        spline_list_extruded = [mt.copy().create.extruded(extrusion_vector=[0,0,1]) for mt in spline_list] 
        ...
        # lower left
        spline_list_extruded[6].control_points[10] = spline_list_extruded[6].control_points[10] - vec
        spline_list_extruded[6].control_points[11] = spline_list_extruded[6].control_points[11] - vec
        spline_list_extruded[6].control_points[12] = spline_list_extruded[6].control_points[12] + vec
        spline_list_extruded[6].control_points[13] = spline_list_extruded[6].control_points[13] + vec

        # lower right
        spline_list_extruded[7].control_points[14] = spline_list_extruded[7].control_points[14] + vec
        spline_list_extruded[7].control_points[15] = spline_list_extruded[7].control_points[15] + vec
        spline_list_extruded[7].control_points[8] = spline_list_extruded[7].control_points[8] - vec
        spline_list_extruded[7].control_points[9] = spline_list_extruded[7].control_points[9] - vec
        # upper left
        spline_list_extruded[8].control_points[14] = spline_list_extruded[8].control_points[14] + vec
        spline_list_extruded[8].control_points[15] = spline_list_extruded[8].control_points[15] + vec
        spline_list_extruded[8].control_points[8] = spline_list_extruded[8].control_points[8] - vec
        spline_list_extruded[8].control_points[9] = spline_list_extruded[8].control_points[9] - vec

        # upper right
        spline_list_extruded[9].control_points[10] = spline_list_extruded[9].control_points[10] - vec
        spline_list_extruded[9].control_points[11] = spline_list_extruded[9].control_points[11] - vec
        spline_list_extruded[9].control_points[12] = spline_list_extruded[9].control_points[12] + vec
        spline_list_extruded[9].control_points[13] = spline_list_extruded[9].control_points[13] + vec
